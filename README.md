...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>위희찬</td>
      <td>프로젝트 주제를 정할떄 본인의 경험을 살려 흔하지 않은 경쟁력 있는 주제를 하게 되었고 전체적인 프로젝트 흐름을 자세히 공부하셔서 발표를 무에서 유를 창조하셨습니다.</td>
    </tr>
    <tr>
      <td>이선호</td>
      <td></td>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>위희찬</td>
      <td>프로젝트 중에 팀의 리더 역할을 하셨습니다, 팀원간 의견조율과 프로젝트 환경을 구성 수정 하시고 웹페이지 개발을 해주셨습니다. </td>
    </tr>
    <tr>
      <td>이선호</td>
      <td></td>
